  ...
  React.useEffect(() => {
    ...
    if(!user) return (
        <div className={styles.header2}>
         <img style={{width: '90px', cursor: 'pointer'}} onClick={()=> history.push('/')} src="/icons/logoo.png" alt="arc-invoice" />
        <button onClick={()=> history.push('/login')} className={styles.login}>Proceed</button>
        </div>
    )
    return (
