...
export const signup = async (req, res)=> {
    const { firstName, lastName, email, password, confirmPassword, profilePicture, bio } = req.body
        ...
        .then(user=>{
            ...
            user.save().then((result)=>{
                transporter.sendMail({
                    to:user.email,
                    from:"Octopus<hello@octopus.com>",
                    subject:"Password reset request",
                    html:`
                    <p>You requested for password reset from Octopus Invoicing application</p>
                    <h5>Please click this <a href="https://octopus.com/reset/${token}">link</a> to reset your password</h5>
                    <p>Link not clickable?, copy and paste the following url in your address bar.</p>
                    <p>https://octopus.com/reset/${token}</p>
